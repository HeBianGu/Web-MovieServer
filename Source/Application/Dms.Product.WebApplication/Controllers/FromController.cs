...
namespace Dms.Product.WebApplication.Controllers
{
    ...
    {
        private readonly IFromRespository _respository;

        public FromController(IFromRespository respository)
        {
        ...
        public async Task<IActionResult> Create(mbc_db_fromtype mbc_dv_movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, mbc_db_fromtype mbc_dv_movie)
        {
