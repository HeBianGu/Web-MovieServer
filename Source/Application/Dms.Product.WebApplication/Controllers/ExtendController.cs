...
namespace Dms.Product.WebApplication.Controllers
{
    ...
    {
        private readonly IExtendRespository _respository;

        public ExtendController(IExtendRespository respository)
        {
        ...
        public async Task<IActionResult> Create(mbc_db_extendtype mbc_dv_movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id,  mbc_db_extendtype mbc_dv_movie)
        {
