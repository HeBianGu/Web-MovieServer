...
namespace Dms.Product.WebApplication.Controllers
{
    ...
    {
        private readonly ITagRespository _respository;

        public TagController(ITagRespository respository)
        {
        ...
        public async Task<IActionResult> Create(mbc_db_tagtype mbc_dv_movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id,  mbc_db_tagtype mbc_dv_movie)
        {
