...
namespace Dms.Product.WebApplication.Controllers
{
    ...
    {
        private readonly IMediaRespository _respository;

        public MediaController(IMediaRespository respository)
        {
        ...
        public async Task<IActionResult> Create(mbc_db_mediatype mbc_dv_movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, mbc_db_mediatype mbc_dv_movie)
        {
