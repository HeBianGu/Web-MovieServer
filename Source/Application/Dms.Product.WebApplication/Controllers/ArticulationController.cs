...
{
    public class ArticulationController : ControllerBase
    {
        private readonly IArticulationRespository _respository;

        public ArticulationController(IArticulationRespository respository)
        {
        ...
        public async Task<IActionResult> Create(mbc_db_articulationtype mbc_dv_movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, mbc_db_articulationtype mbc_dv_movie)
        {
