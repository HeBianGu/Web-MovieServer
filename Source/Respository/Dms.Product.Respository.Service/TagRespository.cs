...
{
    public class TagRespository : UserLoggerRepositoryBase<mbc_db_tagtype>, ITagRespository
    {
        public TagRespository(DataContext dbcontext, ILogger<TagRespository> logger) : base(dbcontext, logger)
        {
