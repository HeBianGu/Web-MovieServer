...
{
    public class ArticulationRespository : UserLoggerRepositoryBase<mbc_db_articulationtype>, IArticulationRespository
    {
        public ArticulationRespository(DataContext dbcontext, ILogger<ArticulationRespository> logger) : base(dbcontext, logger)
        {
