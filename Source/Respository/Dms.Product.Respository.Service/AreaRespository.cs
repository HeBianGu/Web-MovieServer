...
{
    public class AreaRespository : UserLoggerRepositoryBase<mbc_db_areatype>, IAreaRespository
    {
        public AreaRespository(DataContext dbcontext, ILogger<AreaRespository> logger) : base(dbcontext, logger)
        {
